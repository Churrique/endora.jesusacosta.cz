...
$codigo_operacion="cic";  //IMPORTANTE ESTE CODIGO Define el nombre de operación asociada a esta interfaz
...
if(trim($_POST['cedula1'])<>'')
{
    ...
    if(mysql_num_rows($result)==1)
    {
        ...
        $_SESSION['tipo_personal']=$aux['tipo_personal'];
        ...
        header('Location: imprimir_carnet_personal2.php');
        exit;
     }
     else
     {
            $error1 = 'Error. Cédula inválida, no existe en la Base de Datos';
     }
...
else
{
    ...
    {
        $error1="Introduzca la cédula a consultar";
    }
}
...
include("formas/imprimir_carnet_personal.html");
