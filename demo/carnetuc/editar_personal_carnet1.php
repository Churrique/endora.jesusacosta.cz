...
if(isset($_POST['cancelar_actualizar_personal']))
{
    header('Location: editar_personal_carnet.php?mensaje=2');
    exit;
}
     ...
     else
     {
        ...
        else
        {
             ...
             else
             {
               ...
               //{
                  $sql="update $tabla_personal_carnet set `nacionalidad`='$_POST[nacionalidad]',`primer_nombre`='$primer_nombre',`segundo_nombre`='$segundo_nombre',`primer_apellido`='$primer_apellido',`segundo_apellido`='$segundo_apellido',`tipo_personal`='$_POST[listado_tipos]',`dependencia`='$_POST[listado_dependencias]',`fecha_registro`='$hoy2',`chequeado_por`='$operador' WHERE cedula='$cedula'";
               //}
               /*else
               {
               ...
               $result=ejecutar($sql,$conexion);
               header('Location: editar_personal_carnet.php?mensaje=1');   
               exit;
             }
        }
   }
...
include ("formas/editar_personal_carnet1.html");
