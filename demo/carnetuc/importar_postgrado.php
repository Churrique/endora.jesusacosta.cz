...
$codigo_operacion="cipos";  //IMPORTANTE ESTE CODIGO Define el nombre de operación asociada a esta interfaz
...
if(isset($_POST['importardepositos']))
{
    ...
    {
        $error="Debe seleccionar el archivo de postgrado a importar";
    }
    else
    {
...
//                $cedula=(int)$data[0];
//                $nacionalidad=$data[1];
//                $primer_nombre=trim($data[2]);
//                $segundo_nombre=trim($data[3]);
//                $primer_apellido=trim($data[4]);
//                $segundo_apellido=trim($data[5]);
//                $facultad=$data[6];
//                $carrera=$data[7];
...
include ("formas/importar_postgrado.html");
