        ...
        else
        {
            ...
            $result=ejecutar($sql,$conexion);
               ...
               if (mysql_num_rows($result)>=1)
               {
                  ...
                  header('Location: editar_estudiante_postgrado1.php');
                  exit;  
...
if(isset($_GET['mensaje']))
{
    switch($_GET['mensaje'])
    {
        case 1:
            ...
            break;
        case 2:
            $error="No se ha realizó ningún cambio en la base de datos";
            break;   
    }
} 
...
include ("formas/editar_estudiante_postgrado.html");
