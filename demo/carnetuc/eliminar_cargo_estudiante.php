...
if(isset($_POST['eliminar_cargo']))
{
    ...
    {
        $sql="delete from $tabla_cargoestudiante_carnet where nombre_cargo='$_SESSION[cargo_nombre]'";
        $result=ejecutar($sql,$conexion);
        header('Location: editar_cargo_estudiante.php?error=4');
        exit;
        
    }
    else
    {
        $error="Debe seleccionar la opción 'SI' para eliminar el cargo";
    }
}
else
{
...
include ("formas/eliminar_cargo_estudiante.html");
