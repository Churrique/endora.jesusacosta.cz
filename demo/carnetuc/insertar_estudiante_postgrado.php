...
$codigo_operacion="ciep";  //IMPORTANTE ESTE CODIGO Define el nombre de operación asociada a esta interfaz
...
if(isset($_POST['cancelar_insertar_estudiante_postgrado']))
{
...
if(isset($_POST['insertar_estudiante_postgrado']))
{
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                $conexion=conectar($host_carnet,$usuario_carnet,$clave_carnet,$database_carnet);   
                                $sql="select * from $tabla_estudiante_postgrado where cedula=$_POST[cedula]";
...
include ("formas/insertar_estudiante_postgrado.html");
