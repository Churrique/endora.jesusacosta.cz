...
if(isset($_POST['actualizar_cargo']))
{
    if($_POST['seleccion']=="si")
    {
        ...
        $sql="update $tabla_autoridad_carnet set nombre_autoridad='$nombre' where nombre_autoridad='$_SESSION[cargo_nombre]'";
        $result=ejecutar($sql,$conexion);
        header('Location: editar_cargo_autoridad.php?error=5');
        exit;
...
include ("formas/modificar_cargo_autoridad.html");
