...
<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tabla_body">
  ...
  <form name="FrmDiploma2" method="post" action="form-diplomas-redirecciona-2.php">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <tr>
        <td align="center" valign="middle" bgcolor="#F3F7F8"><img src="../imagenes/graduado-con-honores-argorgot.fw.png" width="500" height="152" alt="diploma_graduado_con_honores" /></td>
        </tr>
        </table></td>
      </tr>
      <tr>
        <td height="30" align="center"><table width="80%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="50" colspan="3" align="center" valign="bottom"><input name="btnRegresar" type="submit" class="glow2" title="Pulse aquí para Regresar a la pantalla principal..." value="Regresar" /><input style="margin-left:10px" name="btnGconH" type="submit" class="glow2" title="Pulse aquí para generar el diploma Graduado con Honores e Imprimirlo posteriormente..." value="Generar e Imprimir" /><!--<a href="form-diplomas-redirecciona-2.php" target="new"><img style="margin-left:10px; position:absolute" src="../imagenes/boton-imprimir.fw.png" width="65" height="22" alt="reporte" /></a>--></td>
            </tr>
        </table></td>
      </tr>
      <tr>
