...
<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tabla_body">
  ...
  ?>
    <form name="MuesTodo" method="post" action="form-inscripciones-anteriores-consulta-2.php" >
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="15">&nbsp;</td>
      </tr>
      <tr>
        <td height="30" class="gradiente_gris2"><span class="texto_decorado_blanco_amarillo">Consulta General de Inscripciones Anteriores (del SiDICEs) ORDENACIÓN: <?php echo $_GET['ORDENACION']; ?></span></td>
        </tr>
      <tr>
        <td height="15" align="center">&nbsp;</td>
        </tr>
      <tr>
        <td height="40" align="center"><?php $valor_debuelto = ConsuGenDeIA($_GET['ORDENACION']);echo $valor_debuelto; ?></td>
        </tr>
      <tr>
