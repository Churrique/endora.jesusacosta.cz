...
<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tabla_body">
  ...
  ?>
  <form name="FrmConEgreAnt" method="post" action="form-egresados-anteriores-consulta-acciona-2.php">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="30" colspan="5" class="gradiente_gris2"><span class="texto_decorado_blanco_amarillo">Consulta de Egresados Anteriores (del SiDICEs)</span></td>
        </tr>
      <tr>
        <td width="26%" height="15">&nbsp;</td>
        <td width="39%" height="15">&nbsp;</td>
      ...
      <tr>
        ...
        <td height="50"><input name="txtBnombre" type="text" class="cuadro_textbox_5" title="Indique el Nombre...!" size="40" maxlength="100" /></td>
        </tr>
      <tr>
        ...
        <td height="50"><input name="txtBapellido" type="text" class="cuadro_textbox_5" title="Indique el Apellido...!" size="40" maxlength="100" /></td>
        </tr>
      <tr>
        <td height="20">&nbsp;</td>
        <td height="20">&nbsp;</td>
      ...
      <tr>
        ...
        <td height="80" colspan="3"><div class="txt_pie" style="margin-left: 11px; margin-right: 9px; line-height: 17px; text-align:center;">IMPORTANTE<br />Para &laquo;Ver Todo&raquo;: Indique la ordenaci&oacute;n previa antes de pulsar el bot&oacute;n...!</div></td>
        </tr>
      <tr>
        <td height="20">&nbsp;</td>
        <td height="20">&nbsp;</td>
      ...
      <tr>
        ...
        <td height="30" colspan="3"><div class="txt_pie" style="margin-left: 11px; margin-right: 9px; line-height: 17px; text-align:center;">A DISPOSICI&Oacute;N<br />Tambi&eacute;n est&aacute; a la disposici&oacute;n, de consulta, un gran n&uacute;mero de expedientes escaneados, que corresponden a egresados y que no est&aacute;n en este contenedor...!<br /><a href="http://190.170.68.30:8080/publicacionpdf/" target="_blank" title="Pulse aqu&iacute; para ir a esta p&aacute;gina...!"><img src="../imagenes/link_derecho.png" width="30" height="27" alt="link_derecho" /></a></div></td>
        </tr>
      <tr>
        <td height="20">&nbsp;</td>
        <td height="20">&nbsp;</td>
