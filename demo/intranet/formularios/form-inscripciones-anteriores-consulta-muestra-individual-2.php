...
<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tabla_body">
  ...
  <?php
  require_once('../funciones/valida-funciones_ant_inscripciones.php');

  $recor = ConEspDeInsAnt($_GET['ID']);
  if (is_string($recor) ) {
	  echo $recor;
  }
  ?>
  <form name="FrmMuestraIndi" method="post" action="form-inscripciones-anteriores-consulta-2.php">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="30" colspan="5" class="gradiente_gris2"><span class="texto_decorado_blanco_amarillo">Consulta Individual de Insrcipciones Anteriores (del SiDICEs)</span></td>
        </tr>
      <tr>
        <td width="26%" height="15">&nbsp;</td>
        <td width="48%" height="15">&nbsp;</td>
      ...
      <tr>
        <td height="50"><div align="right" class="texto_decorado_agua_marina" style="margin-right: 9px; line-height: 20px;">Facultad</div></td>
        <td height="50">
        <?php
        echo '<input name="txtFacultad" type="text" value="'.$recor['facultad'].'" class="cuadro_textbox_5" title="Indique la Facultad...!" size="50" maxlength="100" />';
		?>
        </td>
        <td height="50">&nbsp;</td>
        <td height="50">&nbsp;</td>
      ...
      <tr>
        <td height="50"><div align="right" class="texto_decorado_agua_marina" style="margin-right: 9px; line-height: 20px;">Escuela</div></td>
        <td height="50">
        <?php
        echo '<input name="txtEscuela" type="text" value="'.$recor['escuela'].'" class="cuadro_textbox_5" title="Indique la Escuela...!" size="50" maxlength="100" />';
		?>
        </td>
        <td height="50">&nbsp;</td>
        <td height="50">&nbsp;</td>
      ...
      <tr>
        <td height="50"><div align="right" class="texto_decorado_agua_marina" style="margin-right: 9px; line-height: 20px;">Menci&oacute;n</div></td>
        <td height="50">
        <?php
        echo '<input name="txtMencion" type="text" value="'.$recor['mencion'].'" class="cuadro_textbox_5" title="Indique la Menci&oacute;n...!" size="50" maxlength="100" />';
		?>
        </td>
        <td height="50">&nbsp;</td>
        <td height="50">&nbsp;</td>
      ...
      <tr>
        <td height="50"><div align="right" class="texto_decorado_agua_marina" style="margin-right: 9px; line-height: 20px;">Fecha de Inscripci&oacute;n</div></td>
        <td height="50">
        <?php
        echo '<input name="txtFechIns" type="text" value="'.$recor['fecha_inscripcion'].'" class="cuadro_textbox_5" title="Indique la Fecha de Inscripci&oacute;n...!" size="10" maxlength="10" />';
		?>
        </td>
        <td height="50">&nbsp;</td>
        <td height="50">&nbsp;</td>
      ...
      <tr>
        <td height="50"><div align="right" class="texto_decorado_agua_marina" style="margin-right: 9px; line-height: 20px;">Tipo de Inscripci&oacute;n</div></td>
        <td height="50">
        <?php
        echo '<input name="txtInscripcion" type="text" value="'.$recor['tipo_inscripcion'].'" class="cuadro_textbox_5" title="Indique el Tipo de Inscripci&oacute;n...!" size="50" maxlength="100" />';
		?>
        </td>
        <td height="50">&nbsp;</td>
        <td height="50">&nbsp;</td>
      ...
      <tr>
        <td height="50"><div align="right" class="texto_decorado_agua_marina" style="margin-right: 9px; line-height: 20px;">Modalidad de Ingreso</div></td>
        <td height="50">
        <?php
        echo '<input name="txtModalidad" type="text" value="'.$recor['modalidad_ingreso'].'" class="cuadro_textbox_5" title="Indique la Modalidad de Ingreso...!" size="50" maxlength="100" />';
		?>
        </td>
        <td height="50">&nbsp;</td>
        <td height="50">&nbsp;</td>
      ...
      <tr>
        <td height="50"><div align="right" class="texto_decorado_agua_marina" style="margin-right: 9px; line-height: 20px;">T&iacute;tulo de Bachiller</div></td>
        <td height="50">
        <?php
        echo '<input name="txtTituloBach" type="text" value="'.$recor['titulo_bachiller'].'" class="cuadro_textbox_5" title="Indique el T&iacute;tulo de Bachiller...!" size="50" maxlength="100" />';
		?>
        </td>
        <td height="50">&nbsp;</td>
        <td height="50">&nbsp;</td>
