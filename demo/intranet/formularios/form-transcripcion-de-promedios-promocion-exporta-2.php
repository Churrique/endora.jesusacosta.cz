...
<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tabla_body">
  ...
  ?>
      <form name="FormExporPNR" method="post" action="form-transcripcion-de-promedios-promocion-2.php">
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      <td height="15">&nbsp;</td>
	      </tr>
	    <tr>
	      <td height="30" align="left" class="gradiente_gris1"><span class="texto_decorado_blanco_amarillo">Exportar Promedio(s) No Relacionado (PNR)</span></td>
	      </tr>
	    <tr>
	      <td height="15">&nbsp;</td>
	      </tr>
	    <tr>
	      <td height="30" align="center"><span class="texto_decorado_am">... en desarrollo...!</span></td>
	      </tr>
	    <tr>
	      <td height="15">&nbsp;</td>
	      </tr>
	    <tr>
	      <td height="30" align="center"><input type="submit" name="btnAtras" id="btnRegresar" value="Regresar" class="cuadro_textbox_4" /></td>
	      </tr>
	    <tr>
	      <td height="15">&nbsp;</td>
	      </tr>
