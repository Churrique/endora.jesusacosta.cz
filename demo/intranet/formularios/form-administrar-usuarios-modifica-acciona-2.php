...
<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tabla_body">
  ...
  <form name="FrmCambiaPNE" method="post" action="form-administrar-usuarios-2.php">
  <table width="90%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="40" align="center" valign="middle">
        ...
        echo MFUsuario('Intranet','U-PASS',$usuario,$contrasenia);
        ?>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="40" align="center" valign="middle">
      <input name="btnContinuar" type="submit" class="glow2" title="Pulse aqu&iacute; para continuar..." value="Continuar" />
      </td>
    </tr>
  </table>
  </form>
