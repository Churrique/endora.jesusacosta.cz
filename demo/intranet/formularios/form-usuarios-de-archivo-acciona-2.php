<?php
  require_once('..//funciones/valida-funciones_form-usuarios-de-archivo.php');
...
<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tabla_body">
  ...
  <td height="40" align="center" valign="middle"><!-- InstanceBeginEditable name="EditRegion1" -->
      ...
      <br />
  <form name="FrmUsDArch" method="post" action="form-usuarios-de-archivo-2.php" >
    <table width="80%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="39%" height="30" class="Edicion_2"><?php echo $_POST['txtCI']; ?></td>
        <td width="31%" height="30">&nbsp;</td>
      </tr>
      <tr>
        <td height="30" align="right" class="DetalleCeroUno">Nombre(s)</td>
        <td height="30">&nbsp;</td>
        <td height="30" class="Edicion_2"><?php echo $_POST['txtNyA']; ?></td>
        <td height="30" class="footer_rojo">* Opcional</td>
      </tr>
      <tr>
        <td height="40" colspan="4" align="center"><input name="btnRegresa" type="submit" class="glow2" title="Pulse aqu&iacute; para regresar a la pantalla anterior..." value="Regresar"  /></td>
        </tr>
      <tr>
        <td height="30">&nbsp;</td>
        <td height="30">&nbsp;</td>
      ...
      <tr>
        <td height="50" colspan="4" align="center" valign="middle" class="Inportant">
        <?php
		  if ( isset($_POST['btnEnviar']) ) {
			  ...
			  if ( is_string($registros) ) {
				  ...
				  while ( $rows = mysqli_fetch_assoc($registros) ) {
					  echo IncUss($_POST['txtCI'],$rows['id_tarea']);
				  }
			  }
		  }
		?>
