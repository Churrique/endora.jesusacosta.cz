...
<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tabla_body">
  ...
  <td height="40" align="center" valign="middle"><!-- InstanceBeginEditable name="EditRegion1" -->
      ...
      <br />
<div align="center">
  <form name="FrmCreaMod" method="post" >
    <table width="80%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <th width="139" height="30" scope="col">&nbsp;</th>
        <th width="8" height="30" scope="col">&nbsp;</th>
        <th width="428" height="30" scope="col">&nbsp;</th>
        <th width="202" height="30" scope="col">&nbsp;</th>
      </tr>
      <tr>
        <th height="45" scope="col">&nbsp;</th>
        <th width="8" height="45" scope="col">&nbsp;</th>
        <th height="45" scope="col">&nbsp;</th>
        <th height="45" scope="col">&nbsp;</th>
      </tr>
      <tr>
        <td height="45" align="right" class="DetalleCeroUno">M&oacute;dulo:</td>
        <td width="8" height="45">&nbsp;</td>
        <td height="45"><input name="txtModulo" type="text" class="Edicion_2" title="Escriba aquí el nombre para el nuevo módulo..." size="35" maxlength="25"  /></td>
        <td height="45"><input name="btnAdiModu" type="submit" class="glow2" title="Pulse aquí para adicionar este módulo...!" value="Adicionar"  /></td>
      </tr>
      <tr>
        <td height="45">&nbsp;</td>
        <td width="8" height="45">&nbsp;</td>
      ...
      <tr>
        <td height="30" colspan="4" align="center" class="Edicion_2">M&oacute;dulos Existentes</td>
        </tr>
      <tr>
        <td height="30" colspan="4" align="center"><p>&nbsp;</p>
        <?php
		$registros = MueAgruDMod();
		if (is_string($registros)) {
			...
			while ($rows = mysqli_fetch_array($registros, MYSQLI_ASSOC)) {
				...
				echo '<td height="50" align="center" class="DetalleCeroDos">'.$rows['detalle_modulo'].'</td>
					  <td width="60" height="50" align="center" valign="middle"><a href="form-administrar-egresados-constancias-modifica-2.php" title="Editar...!" target="_self"><img src="../imagenes/editar.png" width="46" height="46" alt="editar" /></a></td>
					  <td width="60" height="50" align="center" valign="middle"><a href="form-administrar-egresados-constancias-elimina-2.php" title="Eliminar...!" target="_self"><img src="../imagenes/eliminar.png" width="43" height="43" alt="eliminar" /></a></td>';
				if ( !is_null($rows['id_modulo_contenido']) ) {
					echo '<td width="60" height="50" align="center" valign="middle"><a href="form-administrar-egresados-constancias-define-2.php?id='.$rows['id_modulo'].'&modulo='.$rows['detalle_modulo'].'" title="Ver Documentos...!" target="_self"><img src="../imagenes/con_documentos_definidos.fw.png" width="56" height="45" alt="con_doc_def" /></a></td>';
				}
				else {
