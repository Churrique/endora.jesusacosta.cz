  ...
  <td height="40" align="center" valign="middle"><!-- InstanceBeginEditable name="EditRegion1" -->
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	    ...
	    <tr>
          ...
          &nbsp;&nbsp;&nbsp;
          <input type="submit" name="btnModificar" id="btnModificar" value="Modificar" title="Click aquí para confirmar que desea Modificar este registro..." class="cuadro_textbox_4" />
          </td>
	      <td height="55">&nbsp;</td>
	      <td height="55">&nbsp;</td>
	      <td height="55">&nbsp;</td>
