...
<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tabla_body">
  ...
  $recor = ConEspDeProAnt($_GET['ID']);
  if (is_string($recor) ) {
	  echo $recor;
  }
  ?>
  <form name="FrmMuestraIndi" method="post" action="form-promedios-anteriores-consulta-2.php">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="30" colspan="5" class="gradiente_gris2"><span class="texto_decorado_blanco_amarillo">Consulta Individual de Promedios Anteriores (del SiDICEs)</span></td>
        </tr>
      <tr>
        <td width="26%" height="15">&nbsp;</td>
        <td width="48%" height="15">&nbsp;</td>
      ...
      <tr>
        <td height="50"><div align="right" class="texto_decorado_agua_marina" style="margin-right: 9px; line-height: 20px;">Promedio Ponderado</div></td>
        <td height="50">
        <?php
        echo '<input name="txtFacultad" type="text" value="'.$recor['promedio_ponderado'].'" class="cuadro_textbox_5" title="Indique el Promedio Ponderado...!" size="10" maxlength="6" />';
		?>
        </td>
        <td height="50">&nbsp;</td>
        <td height="50">&nbsp;</td>
      ...
      <tr>
        <td height="50"><div align="right" class="texto_decorado_agua_marina" style="margin-right: 9px; line-height: 20px;">Promedio Sim&eacute;trico</div></td>
        <td height="50">
        <?php
        echo '<input name="txtEscuela" type="text" value="'.$recor['promedio_simetrico'].'" class="cuadro_textbox_5" title="Indique el Promedio Sim&eacute;trico...!" size="10" maxlength="6" />';
		?>
        </td>
        <td height="50">&nbsp;</td>
        <td height="50">&nbsp;</td>
      ...
      <tr>
        <td height="50"><div align="right" class="texto_decorado_agua_marina" style="margin-right: 9px; line-height: 20px;">Puesto Individual</div></td>
        <td height="50">
        <?php
        echo '<input name="txtMencion" type="text" value="'.$recor['puesto_individual'].'" class="cuadro_textbox_5" title="Indique el Puesto Individual...!" size="3" maxlength="5" />';
		?>
        </td>
        <td height="50">&nbsp;</td>
        <td height="50">&nbsp;</td>
      ...
      <tr>
        <td height="50"><div align="right" class="texto_decorado_agua_marina" style="margin-right: 9px; line-height: 20px;">Puesto en Promoci&oacute;n</div></td>
        <td height="50">
        <?php
        echo '<input name="txtFechIns" type="text" value="'.$recor['puesto_promocion'].'" class="cuadro_textbox_5" title="Indique el Puesto en Promoci&oacute;n...!" size="3" maxlength="6" />';
		?>
        </td>
        <td height="50">&nbsp;</td>
        <td height="50">&nbsp;</td>
