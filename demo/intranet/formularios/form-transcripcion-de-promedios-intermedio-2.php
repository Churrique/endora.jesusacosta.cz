...
<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tabla_body">
  ...
  <td height="40" align="center" valign="middle"><!-- InstanceBeginEditable name="EditRegion1" -->
	  ...
	  ?>
      <form name="Form-TPro" method="post" id="Form-TProIgr" action="form-transcripcion-de-promedios-promocion-2.php">
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	    ...
	    <tr>
		  ...
		  if ( isset($_POST['btnEnviar']) ) {
			  echo '<div class="texto_decorado_azul3">';
			  //echo (is_null($_POST[''txtPromedioPro']) || empty($_POST[''txtPromedioPro']))?'NULL':$_POST[''txtPromedioPro'];
			  echo Ins1Promocion($_POST['txtTitulo'],(is_null($_POST['txtFechaActo']) || empty($_POST['txtFechaActo']))?NULL:$_POST['txtFechaActo'],(is_null($_POST['txtIntegra']) || empty($_POST['txtIntegra']))?'NULL':$_POST['txtIntegra'],(is_null($_POST['txtPromedioPro']) || empty($_POST['txtPromedioPro']))?'NULL':$_POST['txtPromedioPro']);
			  echo '</div>';
		  }
		  ?>
          <br /><br /><div align="center" style="margin: 10px 5px 10px 5px">
          <?php
		  echo ConGenDP('intranet');
		  ?>
          </div>
          </td>
	      </tr>
	    <tr>
	      ...
	      <tr>
	        <td height="55" colspan="7" align="center" valign="middle"><input type="submit" name="btnRegresar" id="btnRegresar" value="Regresar" class="cuadro_textbox_4" /></td>
	      </tr>
	    <tr>
	      <td height="15">&nbsp;</td>
	      <td height="15">&nbsp;</td>
