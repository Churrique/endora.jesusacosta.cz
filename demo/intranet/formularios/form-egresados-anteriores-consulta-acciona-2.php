...
<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tabla_body">
  ...
  if ( isset($_POST['btnVerTodo']) ) {
	  header('Location: form-egresados-anteriores-ver-todo-2.php?ORDENACION='.$_POST['rbtOrden']);
	  exit;
  }
  ?>
  <form name="FrmResuDCon" method="post" action="form-egresados-anteriores-consulta-2.php">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="30" colspan="5" class="gradiente_gris2"><span class="texto_decorado_blanco_amarillo">Consulta de Egresados Anteriores (del SiDICEs). Criterio de Búsqueda: &laquo;
        <?php
		  if ( isset($_POST['btnBuscar']) ) {
			  ...
			  if ( isset($_POST['txtBnombre']) && $_POST['txtBnombre'] != '' ) {
				  //buscar por nombre
				  echo $_POST['txtBnombre'];
			  }
			  if ( isset($_POST['txtBapellido']) && $_POST['txtBapellido'] != '' ) {
				  //buscar por apellido
				  echo $_POST['txtBapellido'];
			  }
		  }
		?>
        &raquo;</span></td>
      ...
      <tr>
        ...
        <?php
		  if ( isset($_POST['btnBuscar']) ) {
			  if ( isset($_POST['txtBci']) && $_POST['txtBci'] != '' ) {
				  //buscar por cédula
				  $resultado_de_busqueda = CDe1EgrAnt('cedula',$_POST['txtBci']);
				  echo $resultado_de_busqueda;
			  }
			  if ( isset($_POST['txtBnombre']) && $_POST['txtBnombre'] != '' ) {
				  //buscar por nombre
				  $resultado_de_busqueda = CDe1EgrAnt('nombre',$_POST['txtBnombre']);
				  echo $resultado_de_busqueda;
			  }
			  if ( isset($_POST['txtBapellido']) && $_POST['txtBapellido'] != '' ) {
				  //buscar por apellido
				  $resultado_de_busqueda = CDe1EgrAnt('apellido',$_POST['txtBapellido']);
				  echo $resultado_de_busqueda;
			  }
		  }
		?>
