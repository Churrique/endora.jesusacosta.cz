    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="30" align="center"><table width="80%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="50" colspan="3" align="center" valign="middle"><input name="btnImprimir" type="submit" class="glow2" title="Pulse aquí para Imprimir el Diploma..." value="Imprimir" /></td>
            </tr>
        </table></td>
      </tr>
      <tr>
