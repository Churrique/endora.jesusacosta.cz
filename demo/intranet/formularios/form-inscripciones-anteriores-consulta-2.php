...
<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tabla_body">
  ...
  ?>
  <form name="FrmConInsAnt" method="post" action="form-inscripciones-anteriores-consulta-acciona-2.php">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="30" colspan="5" class="gradiente_gris2"><span class="texto_decorado_blanco_amarillo">Consulta de Insrcipciones Anteriores (del SiDICEs)</span></td>
        </tr>
      <tr>
        <td width="26%" height="15">&nbsp;</td>
        <td width="45%" height="15">&nbsp;</td>
