...
<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tabla_body">
  ...
  <td height="40" align="center" valign="middle"><!-- InstanceBeginEditable name="EditRegion1" -->
      ...
      <?php
//		if (isset($_POST['btnOK']) ) header('Location: form-administrar-usuarios-2.php?ID='.$_POST['txtID']);
		if (isset($_POST['btnOK']) ) header('Location: form-administrar-usuarios-modifica-2.php?ID='.$_POST['txtID']);
		EdeU($uusuario,$ucuenta,$uid,$uinicio);
		$vector = MFUsuario('Intranet','CcIDU','','','','',NULL,$_GET['ID']);
	  ?>
      </div>
      <br />
      <form name="FrmAdmUsuMod" id="FrmAdmUsuMod" method="post" action="form-administrar-usuarios-modifica-eliminatarea-accion-2.php" >
      <?php echo '<input type="hidden" name="txtID" value="'.$vector['idusuarios'].'"  />'; ?>
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      <td height="55">&nbsp;</td>
	      <td height="55" align="right" class="texto_decorado_azul1">Usuario:</td>
	      <td height="55" align="left" class="texto_decorado_am"><?php echo $vector['nombre_usuario']; ?></td>
	      <td height="55">&nbsp;</td>
	      </tr>
	    <tr>
	      <td width="4%" height="55">&nbsp;</td>
	      <td width="25%" height="55" align="right" class="texto_decorado_azul1">Tarea Emininada:</td>
	      <td height="55" align="left" class="texto_decorado_am"><?php echo $_GET['TAREA']; ?></td>
	      <td width="3%" height="55">&nbsp;</td>
	    </tr>
	    <tr>
	      <td height="30" colspan="4" class="txt_err">
		  <?php
		  //if ( EliTarDUnUsua($_GET['ID'],$_GET['IDTAREA']) ) echo '<br />Eliminaci&oacute;n exitosa...!<br />';
		  $sentencia = EliTarDUnUsua($_GET['IDTAREA']);
		  if ( is_bool($sentencia) ) {
			  echo '<br />Eliminaci&oacute;n exitosa...!<br />';
		  }
		  else {
			  echo $sentencia;
		  }
	    ...
	    <tr>
          ...
          <input name="btnOK" type="submit" class="glow2" title="Pulse aqu&iacute; para retornar a la pantalla anterior..." value="&lt;&lt; Ok" />
          </td>
	      </tr>
	    </table>
      </form>
